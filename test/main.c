...
/*   Updated: 2026/06/20 20:13:10 by coressor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	map.sky_color[1] = 123;
	map.sky_color[2] = 98;
	map.texture_no = "textures/button2hilite.xpm";
	map.texture_ea = "textures/nuclear.xpm";
	map.texture_so = "textures/obj4-7.xpm";
	map.texture_we = "textures/tiles-117.xpm";
	// map.map = {
	// 	"1111111111111111",
	// 	"1000000000000001",
	// 	"1000000000000001",
